...
extern const float historyKeyframeSearchRadius; // NOT used in Scan Context-based loop detector / default 7.0; key frame that is within n meters from current pose will be considerd for loop closure
extern const int   historyKeyframeSearchNum; // 2n+1 number of history key frames will be fused into a submap for loop closure
extern const float historyKeyframeFitnessScore; // default 0.3; the smaller the better alignment
