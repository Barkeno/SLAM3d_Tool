...
void ndt_mapping::ndt_odometry(const sensor_msgs::PointCloud2::ConstPtr& input, float* PoseAftNdtOdom)
{
  ...
  PoseAftNdtOdom[2] = current_pose_.yaw;
  PoseAftNdtOdom[5] = current_pose_.x;
  PoseAftNdtOdom[3] = current_pose_.y;
  PoseAftNdtOdom[4] = current_pose_.z;
